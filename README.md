...
『大学入学共通テスト「情報Ⅰ」対策問題集』（技術評論社, ISBN 978-4-297-15084-6）pp.228 連動Webアプリ。

**公開URL**: https://technical-reviewer-information1.github.io/information-system/

スーパーマーケットの情報の流れを図でたどり、POSレジを実際に打ちながら、集まったデータで何ができるかを確かめます。
